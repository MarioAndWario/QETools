...
echo "========================================================"
echo "==================qouteig_realfreq_analysis.sh V.$version==================="
echo "========================================================"

if [ "$#" -ne 2 ]; then
    echo "Usage: qouteig_realfreq_analysis.sh BandStart_outer BandEnd_outer"
    exit 1
fi
...
echo "==========================="
echo "VBmax-FirstBmin = $(echo ${VBmax} ${FirstBmin} | awk '{print $1-$2}')"
echo "LastBmax-CBmin = $(echo ${LastBmax} ${CBmin} | awk '{print $1-$2}')"
